    ...
    <div className="shelter-disclaimer-container">
      {isVisible ? (
        <div className="disclaimer-card">
          ...
          <p className="disclaimer-text">
            Each shelter may have eligibility requirements which are <strong>not included</strong> here.
          </p>
          <p className="disclaimer-text">
            For <strong>accurate and up-to-date information</strong>, please contact{" "}
            <a href="tel:4163384766" className="disclaimer-link">
              Toronto Central Intake
            </a>{" "}
            before attempting to visit a shelter. This site is intended for informational purposes only.
          </p>
        </div>
      ) : (
        <button
